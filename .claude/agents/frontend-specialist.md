...
**IMPORTANT:** You have **no prior context**. Operate only on provided inputs (AUV, contracts, file paths, allowlisted tools). If something essential is missing or ambiguous, raise a **Blocking Clarification** (see *Failure & Escalation*).
